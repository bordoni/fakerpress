...
if ( PHP_VERSION_ID < 80100 ) {
	if ( ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) && is_admin() ) {
		...
		if ( ! is_plugin_active( plugin_basename( __FP_FILE__ ) ) ) {
			...
			echo '<b>FakerPress</b> requires PHP 8.0 or higher, and the plugin has now disabled itself.' .
				'<br />' .
				'To allow better control over dates, advanced security improvements and performance gain.' .
				'<br />' .
				'Contact your Hosting or your system administrator and ask for this Upgrade to version 8.0 of PHP.';
			exit;
		}
