...
class Assets extends Service_Provider {
	...
	public function register() {
		...
		// Register React admin bundle.
		add_action( 'admin_enqueue_scripts', [ $this, 'register_react_assets' ] );
	...
	/**
	 * Register the React admin bundle assets.
	 *
	 * Loads the compiled React + Tailwind admin interface on FakerPress pages.
	 * The asset file is generated by `@wordpress/scripts` build and contains
	 * the dependency list and version hash.
	 *
	 * @since 0.9.0
	 *
	 * @return void
	...
	public function register_react_assets() {
		...
		wp_register_style(
			'fakerpress-admin-react-styles',
			Plugin::url( 'build/admin.css' ),
			[],
			$asset['version']
		);

		wp_enqueue_script( 'fakerpress-admin-react' );
		wp_enqueue_style( 'fakerpress-admin-react-styles' );
	}
