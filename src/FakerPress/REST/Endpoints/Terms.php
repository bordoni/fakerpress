...
class Terms extends Abstract_Endpoint {
	 ...
	 * @var string
	 */
	protected $permission_required = 'manage_categories';
	...
	public function get_request_schema() {
		return [
			...
			'properties' => [
				...
				'taxonomy'  => [
					'type'        => 'string',
					'description' => 'Taxonomy to generate terms for.',
					'default'     => 'category',
					'example'     => 'category',
				],
	...
	public function get_response_schema() {
		return OpenAPI::get_generation_response_schema( 'terms' );
	}
} 
